import type { V11BasicQuestion, V11TaskQuestion, V11InterestQuestion } from '@shared/api.interface';

export const DOCUMENT_BASIC_QUESTIONS: V11BasicQuestion[] = [
  {
    "id": "doc-bq-film_theory-01",
    ...
    "score": 1,
    "rubric": "答对得 1 分，答错得 0 分。",
    "sortOrder": 1,
    "isEnabled": true
  },
  {
    "id": "doc-bq-film_theory-02",
    "dimensionCode": "film_theory",
    "questionType": "single_choice",
  ...
  },
  {
    ...
    "score": 2,
    "rubric": "是否理解“类型片”是一类有相对固定规则的作品；?是否说明类型片能帮助观众快速建立理解和期待；?是否举出合理例子；?是否能把例子和观众期待联系起来。",
    "sortOrder": 901,
    "isEnabled": true
  },
  {
    "id": "doc-bq-short-visual_language",
    "dimensionCode": "visual_language",
    "questionType": "short_answer",
    ...
    "score": 2,
    "rubric": "是否明确选择了镜头、剪辑或声音中的一种；?是否说明了该元素产生的情绪效果；?是否能解释“为什么会影响情绪”；?是否避免只说感受、不说作用机制。",
    "sortOrder": 902,
    "isEnabled": true
  },
  {
    "id": "doc-bq-short-script_narrative",
    "dimensionCode": "script_narrative",
    "questionType": "short_answer",
    ...
    "score": 2,
    "rubric": "是否说明人物目标决定角色行动；?是否说明人物阻碍会产生冲突；?是否说明目标和阻碍共同推动情节；?是否能联系到主线、冲突、剧情推进等分析目的。",
    "sortOrder": 903,
    "isEnabled": true
  },
  {
    "id": "doc-bq-short-aigc_business",
    "dimensionCode": "aigc_business",
    "questionType": "short_answer",
    ...
    "score": 2,
    "rubric": "是否至少说出一个具体优势；?是否至少说出一个具体风险；?是否理解 AIGC 是辅助工具，而不是最终负责人；?是否具备人工审核和风险意识。",
    "sortOrder": 904,
    "isEnabled": true
  },
  {
    "id": "doc-bq-short-analysis",
    "dimensionCode": "analysis",
    "questionType": "short_answer",
    ...
    "score": 2,
    "rubric": "是否先确认问题事实；?是否判断影响范围和严重程度；?是否及时沟通，而不是隐瞒；?是否能提出解决方案；?是否有跟进和复盘意识；?是否体现交付质量和项目风险意识。",
    "sortOrder": 905,
    "isEnabled": true
  }
];

export const DOCUMENT_TASK_QUESTIONS: V11TaskQuestion[] = [
  {
    "id": "doc-tq-1",
    "dimensionCode": "film_theory",
    "title": "任务 1：影视基础理论方向，20 分",
    "scenario": "任选一部熟悉的电影、剧集、短剧或微短剧，完成基础分析。",
    "mainTask": "1. 作品名称及基本类型\n2. 核心主题或情绪卖点\n3. 主角目标与主要冲突\n4. 类型规则或观众期待\n5. 最值得分析或学习的一点",
    "extensionQuestion": "如果这部作品要推荐给目标用户，你会用哪一句话概括它的核心吸引力？为什么？",
    "scoreTotal": 20,
    "rubricJson": "{\"requirements\": [\"作品名称及基本类型；\", \"核心主题或情绪卖点；\", \"主角目标与主要冲突；\", \"类型规则或观众期待；\", \"最值得分析或学习的一点。\"], \"modelPoints\": [\"是否从“作品是什么类型”进一步分析到“为什么属于这个类型”；\", \"是否能把主题、卖点、人物目标、冲突和观众期待联系起来；\", \"是否避免只复述剧情或只表达个人喜好；\", \"是否具备基础影视分析意识。\"]}",
    "sortOrder": 1,
    "isEnabled": true
  },
  {
    "id": "doc-tq-2",
    "dimensionCode": "visual_language",
    "title": "任务 2：视听语言应用方向，20 分",
    "scenario": "任选一段影视片段、短视频片段或广告片段进行视听语言分析。",
    "mainTask": "1. 片段基本信息\n2. 镜头或构图特点\n3. 色彩、光线或美术风格\n4. 声音、音乐或环境音\n5. 剪辑节奏\n6. 视听元素如何服务情绪、人物或叙事",
    "extensionQuestion": "如果预算或素材受限，你会优先保留哪两个视听设计来保证情绪表达？为什么？",
    "scoreTotal": 20,
    "rubricJson": "{\"requirements\": [\"片段基本信息；\", \"镜头或构图特点；\", \"色彩、光线或美术风格；\", \"声音、音乐或环境音；\", \"剪辑节奏；\", \"视听元素如何服务情绪、人物或叙事。\"], \"modelPoints\": [\"是否明确分析具体视听元素，而不是只说观感；\", \"是否说明视听元素如何影响观众情绪；\", \"是否能把画面、声音、剪辑与人物 / 情节 / 主题联系起来；\", \"是否避免只堆术语、不解释作用。\"]}",
    "sortOrder": 2,
    "isEnabled": true
  },
  {
    "id": "doc-tq-3",
    "dimensionCode": "script_narrative",
    "title": "任务 3：剧本叙事拆解方向，20 分",
    "scenario": "任选一部熟悉的影视作品或短剧，完成叙事拆解。",
    "mainTask": "1. 100 字以内概括故事主线\n2. 列出主要人物及人物目标\n3. 分析核心冲突\n4. 梳理至少 3 个关键情节点\n5. 判断故事优点和问题",
    "extensionQuestion": "如果要把这个故事压缩成 1 分钟短视频，你会保留哪几个关键情节点？为什么？",
    "scoreTotal": 20,
    "rubricJson": "{\"requirements\": [\"100 字以内概括故事主线；\", \"列出主要人物及人物目标；\", \"分析核心冲突；\", \"梳理至少 3 个关键情节点；\", \"判断故事优点和问题。\"], \"modelPoints\": [\"是否抓住主线，而不是全文复述；\", \"是否分析人物目标、阻碍和冲突；\", \"是否理解情节点会改变故事方向；\", \"是否能基于具体依据判断故事优缺点。\"]}",
    "sortOrder": 3,
    "isEnabled": true
  },
  {
    "id": "doc-tq-4",
    "dimensionCode": "aigc_business",
    "title": "任务 4：AIGC 业务认知方向，20 分",
    "scenario": "设计一个“AIGC 辅助影视内容生产 / 分析”的简单流程。",
    "mainTask": "1. 可使用 AIGC 的环节\n2. AI 可输出什么\n3. 人工需要审核什么\n4. 可能风险\n5. 降低风险的方法",
    "extensionQuestion": "如果 AI 输出内容存在事实错误或版权风险，你会如何发现、修正并记录？",
    "scoreTotal": 20,
    "rubricJson": "{\"requirements\": [\"可使用 AIGC 的环节；\", \"AI 可输出什么；\", \"人工需要审核什么；\", \"可能风险；\", \"降低风险的方法。\"], \"modelPoints\": [\"是否把 AIGC 定位为辅助工具，而非最终负责人；\", \"是否能说明 AI 用在哪些具体业务环节；\", \"是否有人工审核、事实核验和合规意识；\", \"是否能提出可执行的风险控制方法。\"]}",
    "sortOrder": 4,
    "isEnabled": true
  },
  {
    "id": "doc-tq-5",
    "dimensionCode": "analysis",
    "title": "任务 5：综合分析与项目反馈能力，20 分",
    "scenario": "项目问题反馈与客户沟通\n你正在参与一个影视内容分析项目，原计划周五向客户提交分析报告。但周三下午，你发现：\n部分剧情信息来自二手资料，尚未核对原片；\n短视频传播点分析较弱，缺少明确标题和切片方向；\n客户临时新增“竞品对比”需求。\n如果不调整，报告可能按时提交，但质量有风险；如果补充核验和竞品分析，可能延期半天到一天。",
    "mainTask": "请说明你会如何处理，至少包含：\n1. 如何判断问题严重程度\n2. 先和谁沟通，沟通什么\n3. 如何向客户说明\n4. 提出哪些解决方案\n5. 后续如何跟进和复盘",
    "extensionQuestion": "如果客户坚持不延期，你会如何调整交付范围和风险提示？",
    "scoreTotal": 20,
    "rubricJson": "{\"requirements\": [\"请说明你会如何处理，至少包含：\", \"如何判断问题严重程度；\", \"先和谁沟通，沟通什么；\", \"如何向客户说明；\", \"提出哪些解决方案；\", \"后续如何跟进和复盘。\"], \"modelPoints\": [\"是否体现风险前置，而不是等问题扩大；\", \"是否先内部对齐，再对外沟通；\", \"是否能提出多个可选方案并说明取舍；\", \"是否具备客户意识、协作意识和交付质量意识；\", \"是否有闭环和复盘意识。\"]}",
    "sortOrder": 5,
    "isEnabled": true
  }
];

export const DOCUMENT_INTEREST_QUESTIONS: V11InterestQuestion[] = [
  {
    "id": "doc-iq-1",
    "questionText": "请从五个方向中选择最感兴趣的两个方向，并结合经历说明原因。",
    "score": 5,
    "rubric": "是否明确选择两个方向；?是否说明为什么感兴趣；?是否有经历、作品、学习或实践案例支撑；?是否能体现成长意愿和岗位匹配可能。",
    "sortOrder": 1,
    "isEnabled": true
  },
  {
    ...
    "score": 5,
    "rubric": "是否同时回答“最擅长什么”和“最需要补足什么”；?是否能结合具体经历或案例说明；?是否能区分能力短板和情绪化自评；?是否体现改进意识，而不是只做静态描述。",
    "sortOrder": 2,
    "isEnabled": true
  },
  {
    ...
    "score": 5,
    "rubric": "是否明确优先训练的能力方向；?是否覆盖 7 天，而不是只写总体想法；?每天是否有具体任务和可验收产出；?是否包含反馈、修改或复盘环节；?计划是否符合 7 天内可完成的现实强度。",
    "sortOrder": 3,
    "isEnabled": true
  }
];
